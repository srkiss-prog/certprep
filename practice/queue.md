...
This file is the single source of truth for **what to study next**.
...
- Re-add items to **Revisit** if traps or hesitation recur.
- Do NOT track scores here.
...
- Always paste **exact CBP study guide bullets** into topic.md files.
- Prefer fewer topics with deeper trap coverage over shallow breadth.
- Revisit items aggressively if they fail under speed conditions.
